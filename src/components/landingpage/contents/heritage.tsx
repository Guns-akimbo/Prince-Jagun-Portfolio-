    ...
    <main className="w-full bg-[#F8F8F8] overflow-x-hidden">
      <div className="max-w-410 mx-auto lg:h-[90vh] 2xl:h-[85vh] ">
        <motion.h2
          ...
          className="text-3xl  md:text-4xl lg:text-6xl font-serif font-bold text-[#0F3D2E]  text-center"
        >
          Heritage & Titles
        </motion.h2>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          className="grid xl:grid-cols-2 lg:h-140 gap-10  w-full mx-auto mt-4 lg:mt-24 "
        >
          <div className=" w-full p-4 2xl:p-0 ">
            <Image
              src="/images/title.jpeg"
              alt="Prince seated on throne"
              className="w-full h-70 md:p-9 md:h-130 lg:h-163  xl:h-120 xl:w-11/12 md:object-cover xl:object-contain rounded-2xl "
              width={800}
              height={240}
              priority
            />
          ...
          <div className="text-gray-700 leading-relaxed mb-5 items-end flex justify-center flex-col font-sans p-6">
            <p className="lg:mb-6  mb-4 text-base lg:text-xl 2xl:text-xl ">
            ...
            <p className="mb-10 text-base  2xl:text-xl lg:text-xl  ">
