...
const HeroSection = () => {
  return (
    <main className="relative w-full bg-white overflow-x-hidden 2xl:pt-20  pt-10 md:pt-0 animate-fade-slide-in">
      <div className="relative bg-[#0F3D2E] md:h-[60vh] h-[90vh] lg:h-[60vh] xl:min-h-[100vh] 2xl:pt-20 pt-16 md:pt-0 pb-0 2xl:pb-40 px-4 2xl:px-12 md:px-4 flex items-center  overflow-hidden ">
